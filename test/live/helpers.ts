/**
 * Harness for the **real** `agy` binary.
 *
...
/**
 * Pinned for cost: the point of these tests is agy's *protocol*
...
/**
 * Append one row per real agy turn — there is no quota-readout
...
export function recordUsage(row: {
  ...
  // — this used to read `e.type`, which is never set on a real
