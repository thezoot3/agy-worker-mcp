/**
 * Verbatim usage text agy 1.1.23 prints on a flag error, captured in
 * `.spike/out/probeC.err`. Reproduced so argv-error handling in the real
 * server can be tested against the same bytes.
 */
export const AGY_USAGE = `\
Usage of agy:
